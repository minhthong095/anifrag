...
/// See also:
///
///  * [TabBarRemoveAlignment], which displays a row of tabs.
///  * [TabBarView], which displays a widget for the currently selected tab.
///  * [TabBarRemoveAlignment.indicator], which defines the appearance of the selected tab
...
/// A material design [TabBarRemoveAlignment] tab.
///
...
///  * [TabBarRemoveAlignment], which displays a row of tabs.
///  * [TabBarView], which displays a widget for the currently selected tab.
///  * [TabController], which coordinates tab selection between a [TabBarRemoveAlignment] and a [TabBarView].
///  * <https://material.io/design/components/tabs.html>
class Tab extends StatelessWidget {
  /// Creates a material design [TabBarRemoveAlignment] tab.
  ///
...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _TabBarRemoveAlignmentState tabBar;
...
class TabBarRemoveAlignment extends StatefulWidget
  ...
  /// and the entire [TabBarRemoveAlignment] is scrollable. Otherwise each tab gets an equal
  ...
  /// An optional callback that's called when the [TabBarRemoveAlignment] is tapped.
  ///
  ...
  @override
  _TabBarRemoveAlignmentState createState() => _TabBarRemoveAlignmentState();
}

class _TabBarRemoveAlignmentState extends State<TabBarRemoveAlignment> {
  ...
  @override
  void didUpdateWidget(TabBarRemoveAlignment oldWidget) {
